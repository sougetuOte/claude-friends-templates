...
class RefactoringAnalyzer:
    ...
    def load_config(self, config_path):
        ...
        default_config = {
            ...
            "exclude": [
                ...
                "*.min.js", "*.generated.*", "__pycache__", ".git"
            ]
        }
    ...
    def calculate_cyclomatic_complexity(self, code):
        ...
        control_keywords = [
            ...
            r'\bwhile\b', r'\btry\b', r'\bcatch\b', r'\bcase\b',
            r'\b\?\s*:', r'\&\&', r'\|\|'
        ]
    ...
    def find_duplicates(self, files_content):
        ...
        for file_path, content in files_content.items():
            lines = content.split('\n')
            for i in range(len(lines) - self.config["thresholds"]["duplication"]["minLines"]):
                block = '\n'.join(lines[i:i+self.config["thresholds"]["duplication"]["minLines"]])
                ...
                if block_hash in code_blocks:
                    duplicates.append({
                        ...
                        "file2": file_path,
                        "line2": i + 1,
                        "lines": self.config["thresholds"]["duplication"]["minLines"]
                    })
                else:
        ...
        try:
            ...
            if line_count > self.config["thresholds"]["complexity"]["maxLines"]:
                issues.append({
                    ...
                    "score": line_count / self.config["thresholds"]["complexity"]["maxLines"]
                })
